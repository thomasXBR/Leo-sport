 ...
 * POST /api/webhook/melhorenvio
 * 
 * Esta rota é um alias para /api/shipping/webhook
 * Mantida para compatibilidade com configurações existentes no painel do Melhor Envio
 */
...
// Importar handlers da rota principal
  ...
  try {
    ...
    if (WEBHOOK_LOG_ENABLED) {
      console.log('[Webhook Melhor Envio] Recebido:', {
        ...
        receivedAt,
        event: body.event,
        endpoint: '/api/webhook/melhorenvio',
      });
    }

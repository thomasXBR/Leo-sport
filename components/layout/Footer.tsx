        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/inicio" className="flex items-center space-x-2 mb-4">
              <Image
                src="/images/LeoSports_Logo_png.png"
                alt="LeoSport Logo PNG"
                width={40}
                height={40}
                className="w-8 h-8"
              />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/termos-de-uso" className="text-gray-400 hover:text-white transition-colors">Termos de Uso</Link></li>
            </ul>
          </div>
        </div>

...
>>>>>>> e0d63d464011f11ed11938d67345f5d2bfce1280
    }
...
<<<<<<< HEAD
                <DialogContent className={modalType === 'coupon' || modalType === 'invoice' || modalType === 'products' || modalType === 'partner' ? 'sm:max-w-[900px] max-h-[90vh] overflow-y-auto' : 'sm:max-w-[425px]'}>
=======
